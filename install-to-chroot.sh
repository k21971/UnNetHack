...
NHSUBDIR="unnethack-6.0.14"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/unnethack-6.0.14/var"
# nhdat location
NHDAT_DIR="/unnethack-6.0.14"
# END OF CONFIG
##############################################################################
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-un6014"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-un6014"
